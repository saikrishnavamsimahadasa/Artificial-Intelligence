...
class PerceptronModel(object):
    ...
    def get_prediction(self, x):
        ...
        elif nn.as_scalar(self.run(x)) < 0:   return -1
    ...
    def train(self, dataset):
        ...
        while loop:
            ...
            for x, y in dataset.iterate_once(size):
                #update the weights if prediction is not equal to label
...
class RegressionModel(object):
    ...
    def run(self, x):
        ...
        y1W2 = nn.Linear(predicted_y1, self.W2)
        predicted_y2 = nn.AddBias(y1W2, self.b2)
    ...
    def train(self, dataset):
        ...
        while l_val > 0.01:
            for x, y in dataset.iterate_once(20):
                ...
                grad_wrt_w1, grad_wrt_w2, grad_wrt_b1, grad_wrt_b2 = nn.gradients(self.get_loss(x, y), parameters)
                
                #updating parameter matrices
                ...
                l_val=nn.as_scalar(self.get_loss(x, y))
...
class DigitClassificationModel(object):
    ...
    def run(self, x):
        ...
        y1W2 = nn.Linear(predicted_y1, self.W2)
        predicted_y2=nn.ReLU(nn.AddBias(y1W2, self.b2))
        
        y2W3 = nn.Linear(predicted_y2, self.W3)
        predicted_y3=nn.AddBias(y2W3, self.b3)
    ...
    def train(self, dataset):
        ...
        while dataset.get_validation_accuracy() < 0.97:
           for x, y in dataset.iterate_once(1000):
               ...
               parameters = [self.W1, self.W2, self.b1, self.b2, self.W3, self.b3]
               grad_wrt_w1, grad_wrt_w2, grad_wrt_b1, grad_wrt_b2, grad_wrt_w3, grad_wrt_b3, = nn.gradients(self.get_loss(x, y), parameters)
